...
ORTHRUS crawls a target, fingerprints its stack, runs 50 vulnerability scanners,
...
744-test / lint-clean quality gates.

📐 **Full system spec:** [`docs/PRD.md`](docs/PRD.md) — the granular,
implemented-system PRD: every subsystem (50 scanners, 17 confirmers, 14 recon
...
orthrus/
  ...
  scanners/    50 scanners + base interface + registry
