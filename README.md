...
ORTHRUS crawls a target, fingerprints its stack, runs 51 vulnerability scanners,
...
747-test / lint-clean quality gates.

📐 **Full system spec:** [`docs/PRD.md`](docs/PRD.md) — the granular,
implemented-system PRD: every subsystem (51 scanners, 17 confirmers, 14 recon
...
orthrus/
  ...
  scanners/    51 scanners + base interface + registry
