...
877-test / lint-clean quality gates.
...
- **Bundled practice target.** This repo ships a deliberately-vulnerable app at
  ...
  ```bash
  python tests/integration/reflecting_target.py 8771     # terminal 1
  orthrus scan -t http://127.0.0.1:8771 --aggressive -o report.json   # terminal 2
  ```
...
```bash
orthrus scan -t http://127.0.0.1:8771 -o report.json
