...
1463-test / lint-clean quality gates.
...
| Supply chain | SCA - known-vulnerable JS libraries (retire.js-style), **Subresource Integrity - third-party `<script>`/`<link>` loaded without an `integrity=` hash (the CDN-compromise / Magecart vector)** |
