...
ORTHRUS crawls a target, fingerprints its stack, runs 64 vulnerability scanners,
...
implemented-system PRD: every subsystem (64 scanners, 28 confirmers, 18 recon
...
orthrus/
  ...
  scanners/    64 scanners + base interface + registry
