...
vulnerabilities of a *target you own* (see ``hydra/benchmark/data``). Running a
...
from hydra.benchmark.scorer import BenchmarkReport, Expected, score
...
# Bundled ground-truth files shipped with HYDRA, addressable by bare name.
