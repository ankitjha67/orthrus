...
Converts the in-memory pydantic schemas (``orthrus.core.schemas``) into ORM rows
...
from orthrus.db.models import Callback as CallbackRow
from orthrus.db.models import Endpoint as EndpointRow
from orthrus.db.models import Exploitation as ExploitationRow
from orthrus.db.models import Finding as FindingRow
from orthrus.db.models import Scan as ScanRow
from orthrus.db.models import ScanLog as ScanLogRow
from orthrus.utils import crypto


# --------------------------------------------------------- row -> schema rehydration
# Resume (`orthrus scan --resume`) reloads a previous run's inventory from the DB
...
class Store:
    ...
    async def list_scans(
        ...
        Backs ``orthrus scans`` so an operator can find a scan id to resume or
