...
This is ORTHRUS's primary safety control. Every outgoing request is checked here
before it leaves the process (see ``orthrus.core.http_client``). The policy is
