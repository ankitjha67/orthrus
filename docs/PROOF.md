...
| Automated gates | **1473 tests pass**, `ruff check orthrus tests` clean |
| Coverage | **67 vulnerability scanners · 28 confirmation modules · 18 recon modules** |
...
and 667 → **1473 tests**. (Recon's latest addition is passive IP-address
