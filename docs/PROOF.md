...
| Automated gates | **1330 tests pass**, `ruff check orthrus tests` clean |
| Coverage | **59 vulnerability scanners · 28 confirmation modules · 18 recon modules** |
...
and 667 → **1330 tests**. (Recon's latest addition is passive IP-address
