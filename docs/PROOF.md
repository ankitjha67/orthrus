...
| Automated gates | **1534 tests pass**, `ruff check orthrus tests` clean |
| Coverage | **70 vulnerability scanners · 28 confirmation modules · 18 recon modules** |
...
and 667 → **1534 tests**. (Recon's latest addition is passive IP-address
