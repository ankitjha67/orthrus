...
| Automated gates | **1391 tests pass**, `ruff check orthrus tests` clean |
| Coverage | **64 vulnerability scanners · 28 confirmation modules · 18 recon modules** |
...
and 667 → **1391 tests**. (Recon's latest addition is passive IP-address
