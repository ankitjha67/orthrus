...
| Automated gates | **1364 tests pass**, `ruff check orthrus tests` clean |
| Coverage | **63 vulnerability scanners · 28 confirmation modules · 18 recon modules** |
...
and 667 → **1364 tests**. (Recon's latest addition is passive IP-address
