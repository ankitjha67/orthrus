...
| Automated gates | **1419 tests pass**, `ruff check orthrus tests` clean |
| Coverage | **66 vulnerability scanners · 28 confirmation modules · 18 recon modules** |
...
and 667 → **1419 tests**. (Recon's latest addition is passive IP-address
