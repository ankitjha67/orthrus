...
| Automated gates | **1352 tests pass**, `ruff check orthrus tests` clean |
| Coverage | **60 vulnerability scanners · 28 confirmation modules · 18 recon modules** |
...
and 667 → **1352 tests**. (Recon's latest addition is passive IP-address
