...
| Verified snapshot | 42 scanners · 17 confirmation modules · 13 recon modules · 667 passing tests · `ruff` clean |
...
## 7. Vulnerability scanning subsystem (42 scanners)
...
| CLI commands | 13 |
| Automated tests | **667** (ruff clean) |
...
orthrus/
  ...
  scanners/    42 scanners + base + registry + _injection + _evasion
